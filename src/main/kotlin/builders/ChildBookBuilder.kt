...
class ChildBookBuilder: IBookBuilder {
    var id: Int = 0
    var title: String = ""
    var author: String = ""
    var genre: String = ""
    ...
    override fun build() = ChildBook(id, title, author, genre, language, price, numberOfPages, quantity, inStock, ageRate, description)
}